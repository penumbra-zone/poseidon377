...
//     let mut state = Instance::new(params);
//     state.n_to_1_fixed_hash(vec![*domain_separator, value.0, value.1])
// }
...
//     let mut state = Instance::new(params);
//     state.n_to_1_fixed_hash(vec![*domain_separator, value.0, value.1, value.2])
// }
...
//     let mut state = Instance::new(params);
//     state.n_to_1_fixed_hash(vec![*domain_separator, value.0, value.1, value.2, value.3])
// }
